...
/// `output_icc`: if None, uses sRGB as output
...
pub fn apply_icc_transform(
    ...
    let output_profile = if let Some(out_data) = output_icc {
        Profile::new_icc(out_data)
    ...
    match img {
        ...
        _ => {
            ...
            apply_icc_transform(&converted, input_icc, output_icc)
        }
    }
}
