...
fn main() {
    ...
    if correction.apply_histogram {
        ...
        if correction.dot_color.len() >= 14 {
            adj.output_shadow = [0.0, correction.dot_color[0] as f32,
                correction.dot_color[1] as f32, correction.dot_color[2] as f32];
            adj.output_highlight = [255.0, correction.dot_color[7] as f32,
                correction.dot_color[8] as f32, correction.dot_color[9] as f32];
        }
    }
